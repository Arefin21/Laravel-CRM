...
@section('title')
    <title>Route List | Nurjahan Bazar</title>
@endsection
@section('main')
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">All Route List</h4>
                    </div>
                    ...
                    <div class="table-wrapper">
                        <div class="card-body">
                            ...
                            <div class="add-button text-right">
                                <a href="{{ route('route.create') }}" class="btn btn-primary text-capitalize"><span>Add Route</span></a>
                            </div>
