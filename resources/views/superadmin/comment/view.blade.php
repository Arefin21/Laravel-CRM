...
<div class="content">
        ...
        <div class="row">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title">Lead Form Notes for {{ $lead->assignedUser->name ?? 'Unknown User' }}</h4>
                </div>
                <div class="card-body">
                    <!-- Add Note Section -->
                    {{-- <h4>Add Note</h4>
    ...
    @endphp --}}
    {{-- @php
    $comments = \App\Models\Comment::where('lead_id', $lead->id)
    ...
    @endphp --}}
                            @forelse ($comments as $comment)
                                <tr>
                                    ...
                                    {{-- <td>{{ $comment->created_at->setTimezone('Asia/Dhaka')->format('Y-m-d H:i') }}</td> --}}
