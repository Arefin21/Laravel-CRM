...
class RouteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('route.index')->with('successMsg', 'Route Successfully Saved');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('route.index')->with('successMsg', 'Route Successfully Updated');
    }
    ...
    public function destroy($id)
    {
        ...
        $unitlist->delete();
        return redirect()->back()->with('dangerMsg','Route Successfully Deleted');
    }
}
